...
<head>
  ...
  <script defer src="formValidation.php"></script>
...
<div class="container ">
  ...
  <form action="verifyLogin.php" class="logInForm" method="POST" id = "loginForm">
    ...
    <button type="submit" class="btn logButton" style="background-color: #076A96; color: white;margin-bottom: 5px;">Log In</button>
    <button type="submit" class="btn formSetup" style="background-color: #b9b9b9; color: black;margin-bottom: 25px;" id = "loginButton">Log In With Google</button><br>
  </form>
</div>
