...
<div class="container ">
  ...
  <form action="createUser.php" class="logInForm" method="post">
    ...
    <div class="form-group formSetup">
        ...
        <input type="password" class="form-control" id="pwd" placeholder="Re-enter password" name="cpswd">
      </div>
    <div class="form-group formSetup">
    ...
    <button type="" class="btn formSetup" style="background-color: #b9b9b9; color: black;margin-bottom: 25px;">Sign Up With Google</button><br>
  </form>
</div>
